...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ asset('assets/img/lemon.png') }}">
    <!-- General CSS Files -->
...
<body style="background-color: #EDD9A3;">
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index.html"><i class="fas fa-gem" style="font-size: 18px"></i> <span style="font-size: 17px;"> LEMON </span><span style="font-size: 10px;">Less Money</span></a>
                </div>
        ...
        <footer class="main-footer" style="border-top: 3px solid #17594A;background-color: #17594A;margin-bottom: -20px">
